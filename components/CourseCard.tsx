          ...
          <li key={stop.spot.id} className="flex gap-3">
            ...
            <div className="flex-1 pb-2">
              ...
              <div className="mt-1 flex flex-wrap items-center gap-2">
                ...
                {stop.spot.rating !== undefined && (
                  <span className="text-xs text-amber-600">
                    ★{stop.spot.rating.toFixed(1)}
                    {stop.spot.userRatingsTotal !== undefined && (
                      <span className="text-black/40">（{stop.spot.userRatingsTotal}件）</span>
                    )}
                  </span>
                )}
              </div>
              ...
              {stop.spot.photoRef && (
                <div className="relative mt-2 h-32 w-full max-w-sm overflow-hidden rounded-lg bg-black/5">
                  <Image
                    src={`/api/photo?ref=${encodeURIComponent(stop.spot.photoRef)}&maxwidth=600`}
                    alt={stop.spot.name}
                    fill
                    unoptimized
              ...
              <SpotReviews placeId={stop.spot.id} />
